    ...
    <g:form class="form-horizontal" name="frmSave-Concurso" action="save" id="${concursoInstance?.id}">
        ...
        <div class="tab-content ui-corner-bottom">
            ...
            <div class="tab-pane" id="obras">
                ...
                %{--<div class="row" style="margin-bottom: 10px;">--}%
                    %{--<div class="span9 btn-group" role="navigation">--}%
                        %{--<a href="#" class="btn btn-info" id="btnBuscarObra">--}%
                            %{--<i class="icon-search"></i> Buscar Obra--}%
                        %{--</a>--}%
                    %{--</div>--}%
                %{--</div>--}%
                ...
                <div class="row">
                    <div class="span5">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="hidden" id="obra_id" name="obra.id" value="">
                                <input type="text" id="obra_busqueda" value="" title="" style="width: 180px;">
                                <p class="help-block ui-helper-hidden"></p>
                            </div>
                        </div>
                    </div>
                    <div class="span6">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-append">
                                    <g:field type="text" name="presupuestoReferencial"
                                             class="required number"
                                             value=""
                                             style="text-align: right;width: 180px" readonly=""/>
                                    <span class="add-on">$</span>
                                </div>

                                <p class="help-block ui-helper-hidden"></p>

                                <a href="#" class="btn btn-success" id="btnAgregarObra">
                                    <i class="icon-plus"></i> Agregar Obra</a>
                            </div>
                        </div>
                    </div>
                ...
                <div style="width: 99.7%;height: 250px;overflow-y: auto;float: right;" id="obras_asignadas"></div>
...
<script type="text/javascript">
    ...
    $("#btnAgregarObra").click(function () {
        var concurso = ${concursoInstance?.id};
        var valor = $("#presupuestoReferencial").val();
        var obra = $("#obra_id").val();
        $.ajax({
            type: 'POST',
            url: '${createLink(controller: 'concurso', action: 'agregarObra_ajax')}',
            data: {
                concurso: concurso,
                obra: obra,
                valor: valor
    ...
    function cargarTablaObras () {
        ...
        $.ajax({
            type: 'POST',
            url: '${createLink(controller: 'concurso', action: 'tabla_obras_ajax')}',
            data: {
                concurso: concurso
            },
            success: function (msg){
            $("#obras_asignadas").html(msg)
            }
        });
    }
