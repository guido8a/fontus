...
<html lang="es">
    ...
    <![endif]-->
        ...
        <link rel="shortcut icon" href="${resource(dir: 'images/ico', file: 'fontus.png')}">
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="${resource(dir: 'images/ico', file: 'fontus.png')}">
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="${resource(dir: 'images/ico', file: 'fontus.png')}">
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="${resource(dir: 'images/ico', file: 'fontus.png')}">
